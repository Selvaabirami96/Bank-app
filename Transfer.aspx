<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Transfer.aspx.cs" Inherits="Bank_App.Deposit" %>
  ...
  <link rel="stylesheet" href="css/style.css">
    ...
    <script>
        ...
        function validateForm() {
            var x1 = document.getElementById("did").value;
            if (x1.length < 10 || x1.length > 11) {
                alert("Invalid Destination Account Number");
            }
            else
	...
	<div class="container">
			...
			<div class="row main">
				<div class="main-login main-center" style="width:500px;">
				       <h2 align="center"> Amount Transfer</h2>  
				...
				<div class="form-group">
  				...
  				<div class="form-group">
                    ...
                    <div class="form-group">
							...
							<label for="name" class="cols-sm-2 control-label">Enter Destination Account Number</label>
							...
							<div class="input-group">
								...
								<input type="text" class="form-control" name="accno1" id="did"  placeholder="Enter Destination Account Number" pattern="[0-9]+" required title="Must contain only numbers"/>
